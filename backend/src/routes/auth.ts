...
import { controlDeleteAllNotifications, controlDeleteNotificationById, controlGetAllNotifications, controlGetNotificationById, controlReadAllNotifications, controlReadNotification, controlSendNotification } from '../controllers/notifications';
...
router.post("/friend/remove", authMiddleware, asyncHandler(controlRemoveFriend));
